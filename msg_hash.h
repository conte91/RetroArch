...
enum msg_hash_enums
{
   ...
   MENU_LABEL(OFFLINE_MODE_USING_CACHED_DATA),
   MENU_LABEL(OFFLINE_NO_ACHIEVEMENT_DATA_AVAILABLE),
   MENU_LABEL(ONLINE_ACHIEVEMENT_PENDING_SYNC),
   MENU_LABEL(ONLINE_SYNCED),
   ...
   MENU_LABEL(CHEEVOS_CACHE_ENABLED),
   MENU_LABEL(CHEEVOS_CACHE_MAX_AGE_DAYS),
